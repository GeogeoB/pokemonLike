...
export default class MenuPokemon {
    constructor(c, GameCanvas, menu, actionnable = true) {
        this.pokemonList = [
        ...
        this.pokemonList.push(
            {pokemon : "Retour", name : "Retour", HP: -1, maxHP : 300, level: -1, sexe : "M", 
            type: [""],
            attack: [
            ]}
        )
    ...
    action() {
        console.log(this.pokemonList[this.actualPokemon])

        if (this.pokemonList[this.actualPokemon].pokemon == "Retour") {
            this.opened = false;
            this.menu.reset();
            this.menu.printMenu = true;
        }
    }
